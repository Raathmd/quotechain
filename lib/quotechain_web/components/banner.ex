defmodule QuotechainWeb.Components.Banner do
  @moduledoc """
  QuotechainWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
