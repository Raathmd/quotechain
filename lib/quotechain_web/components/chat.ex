defmodule QuotechainWeb.Components.Chat do
  @moduledoc """
  `QuotechainWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
