defmodule QuotechainWeb.Components.CheckboxCard do
  @moduledoc """
  The `QuotechainWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
