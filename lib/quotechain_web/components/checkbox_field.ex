defmodule QuotechainWeb.Components.CheckboxField do
  @moduledoc """
  QuotechainWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
