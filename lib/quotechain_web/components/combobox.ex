defmodule QuotechainWeb.Components.Combobox do
  @moduledoc """
  The `QuotechainWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
  ...
  use Gettext, backend: QuotechainWeb.Gettext
