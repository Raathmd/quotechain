defmodule QuotechainWeb.Components.Divider do
  @moduledoc """
  The `QuotechainWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `QuotechainWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
