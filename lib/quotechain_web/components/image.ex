defmodule QuotechainWeb.Components.Image do
  @moduledoc """
  The `QuotechainWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
