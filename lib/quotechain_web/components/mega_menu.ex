defmodule QuotechainWeb.Components.MegaMenu do
  @moduledoc """
  The `QuotechainWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
