defmodule QuotechainWeb.Components.Menu do
  @moduledoc """
  The `QuotechainWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `QuotechainWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import QuotechainWeb.Components.Accordion, only: [accordion: 1]
  import QuotechainWeb.Components.Button, only: [button_link: 1]
