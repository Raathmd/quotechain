defmodule QuotechainWeb.Components.NativeSelect do
  @moduledoc """
  The `QuotechainWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `QuotechainWeb.Components.NativeSelect`
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuotechainWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuotechainWeb.Gettext, "errors", msg, opts)
    end
  end
