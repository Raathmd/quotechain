defmodule QuotechainWeb.Components.Overlay do
  @moduledoc """
  The `QuotechainWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `QuotechainWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
