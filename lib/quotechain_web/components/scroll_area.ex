defmodule QuotechainWeb.Components.ScrollArea do
  @moduledoc """
  The `QuotechainWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
