defmodule QuotechainWeb.Components.Spinner do
  @moduledoc """
  The `QuotechainWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `QuotechainWeb.Components.Spinner` module enables developers to provide
