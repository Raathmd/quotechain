defmodule QuotechainWeb.Components.Stepper do
  @moduledoc """
  The `QuotechainWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `QuotechainWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
