defmodule QuotechainWeb.Components.Tabs do
  @moduledoc """
  `QuotechainWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import QuotechainWeb.Components.Badge, only: [badge: 1]
